  ...
  <div class="records-view">
        ...
        <el-row :gutter="16">
          ...
          <el-col :xs="24" :sm="12" :md="8" :lg="6">
            <el-form-item label="起始端口">
              <el-input
                v-model="queryParams.start_port"
                placeholder="请输入起始端口"
                clearable
              />
            </el-form-item>
          ...
          <el-col :xs="24" :sm="12" :md="8" :lg="6">
            <el-form-item label="用户机柜">
              <el-input
                v-model="queryParams.user_cabinet"
                placeholder="请输入用户机柜"
                clearable
              />
            </el-form-item>
    ...
    <el-card class="table-card" shadow="hover">
      ...
      >
        ...
        <el-table-column prop="record_number" label="登记表编号" min-width="140" show-overflow-tooltip />
        <el-table-column prop="datacenter_name" label="机房名称" min-width="120" show-overflow-tooltip />
        <el-table-column prop="circuit_number" label="线路编号" min-width="140" show-overflow-tooltip />
