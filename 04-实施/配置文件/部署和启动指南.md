...
```powershell
cd d:\TREA\sjzx-zonghebuxian\04-实施\backend
npm install
```
...
```powershell
cd d:\TREA\sjzx-zonghebuxian\04-实施\frontend
npm install
```
...
```powershell
# 创建后端数据目录
mkdir d:\TREA\sjzx-zonghebuxian\04-实施\backend\data

# 创建后端上传目录
mkdir d:\TREA\sjzx-zonghebuxian\04-实施\backend\uploads
```
...
```powershell
# 复制数据库文件
copy d:\TREA\sjzx-zonghebuxian\04-实施\backend\data\wiring.db d:\backup\wiring_backup_$(date +%Y%m%d_%H%M%S).db
```
...
# 停止后端服务
# 复制备份文件到数据目录
copy d:\backup\wiring_backup_20240101_020000.db d:\TREA\sjzx-zonghebuxian\04-实施\backend\data\wiring.db
...
```powershell
# 检查目录权限
icacls d:\TREA\sjzx-zonghebuxian\04-实施\backend\data

# 修改目录权限
icacls d:\TREA\sjzx-zonghebuxian\04-实施\backend\data /grant Users:F
```
...
```powershell
# 检查数据库文件是否存在
dir d:\TREA\sjzx-zonghebuxian\04-实施\backend\data
