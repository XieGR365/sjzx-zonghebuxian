...
**文件路径：** `d:\TREA\sjzx-zonghebuxian\部署脚本_\远程部署.bat`
...
**文件路径：** `d:\TREA\sjzx-zonghebuxian\部署脚本_\远程部署_自动.ps1`
...
**文件路径：** `d:\TREA\sjzx-zonghebuxian\部署脚本_\远程部署.ps1`
...
- [远程部署指南.md](file:///d:/TREA/sjzx-zonghebuxian/部署脚本_/远程部署指南.md) - 详细使用指南
- [远程服务器部署完整指南.md](file:///d:/TREA/sjzx-zonghebuxian/部署脚本_/远程服务器部署完整指南.md) - 完整部署指南
- [SSH密钥设置指南.md](file:///d:/TREA/sjzx-zonghebuxian/部署脚本_/SSH密钥设置指南.md) - SSH密钥设置
...
1. **推荐：** 运行 `.\远程部署.bat`（最简单）
2. **自动：** 运行 `.\远程部署_自动.ps1`（完整自动化）
3. **基础：** 运行 `.\远程部署.ps1`（需要SSH密钥）
...
我已经为你创建了完整的远程部署脚本，可以从本地电脑直接远程部署到Linux服务器，不需要在服务器端手动操作。

### 创建的文件：

1. **远程部署.bat** - 一键部署脚本（推荐使用）
2. **远程部署_自动.ps1** - 完整自动化部署脚本
3. **远程部署.ps1** - 基础部署脚本（需要SSH密钥）
4. **远程部署指南.md** - 详细使用指南
5. **远程部署总结.md** - 本文档
