...
确保前端源码位于:
```
d:\TREA\sjzx-zonghebuxian\frontend\
```
...
预期输出:
```
    目录: d:\TREA\sjzx-zonghebuxian\frontend\dist
...
### 4.1 复制构建文件
```powershell
Copy-Item -Path "d:\TREA\sjzx-zonghebuxian\frontend\dist\*" -Destination "D:\wiring-record-system\frontend\" -Recurse -Force
```
